 ...
 */
 ...
 try {
    ...
    var closeCard = '</div>';
    var beginningHTML = '<div class="studentProfileMasonry contentItem col flex-fill w-100" aria-label="' + studentName + '" id="id' + contentID + '" data-position-default="Main" data-position-selected="Main">';
    var endingHTML = '</div>';
