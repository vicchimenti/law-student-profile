 ...
 */
 ...
 try {
    ...
    var closeCard = '</div>';
    var beginningHTML = '<div class="studentProfileWrapper contentItem col w-50" aria-label="' + studentName + '" id="id' + contentID + '" data-position-default="Main" data-position-selected="Main">';
    var endingHTML = '</div>';
